    ...
    <section className='bg-zinc-950 max-w-4xl mx-auto p-4 md:p-6 lg:p-4 xl:p-0'>
      <div className='w-full'>
        ...
        <div className='pt-[2rem] lg:pt-[0.5rem] flex flex-row justify-between'>
          ...
          <div>
            <h1 className='text-yellow-50 text-lg md:text-xl text-right'>{author}</h1>
            <p className='text-muted-foreground text-sm md:text-lg text-right'>{formatDate(publishedAt ?? '')}</p>
          </div>
        </div>

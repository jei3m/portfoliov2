  ...
  education: [
    {
      ...
      description: `<strong>President's List | GWA of 1.0 - 1.25</strong>
    ...
    },
    {
      ...
      description: `<strong>With Honors | Final Avg of 90 - 94</strong>
    &bull; SY 2020-2021
    &bull; SY 2019-2020
    `,
    },
  ...
  experience: [
    {
      ...
      description: `<strong>Key Responsibilities:</strong>
    &bull; Worked on multiple cloud-based systems, built to cater the hospitality and tourism industry.  
  ...
  projects: [
    {
      title: 'Gastos',
      description:
        'A progressive web application designed to track multiple accounts with income and expenses on a daily basis.',
      type: 'Personal Project',
      imageUrl: '/images/projects/gastos.png',
      githubUrl: 'https://github.com/jei3m/gastos-pwa',
      demoUrl: '',
      skills: ['Next JS', 'Typescript', 'MySQL', 'Redis'],
    },
    {
      title: 'GitWrite',
      description:
        'A markdown editor with GitHub integration. Browse your repositories, switch branches, and manage README files.',
      type: 'Personal Project',
    ...
    },
    {
      title: 'AI-Ponics',
      description:
        'A thesis web application developed to monitor plants in an aeroponic system.',
      type: 'School Project',
    ...
    },
    {
      title: 'ScribeAI',
      description:
        'A full-stack document editor built with React JS, React Quill, Firebase, and Gemini AI for content assistance.',
      type: 'Personal Project',
      imageUrl: '/images/projects/scribe.png',
      githubUrl: 'https://github.com/jei3m/scribe-ai',
      demoUrl: 'https://ai-scribe.netlify.app',
      skills: ['React JS', 'Firebase', 'Gemini'],
    },
    {
      title: 'E-Commerce',
      description:
        'A full-stack E-commerce platform built with Laravel, with PayPal integration for online payments.',
      type: 'Personal Project',
      imageUrl: '/images/projects/laravelshop.png',
      githubUrl:
        'https://github.com/jei3m/laravel-ecommerce',
      demoUrl: '',
      skills: ['Laravel', 'Tailwind', 'Paypal'],
    },
    {
      title: 'MERN Products',
      description:
        'A simple product management system built to practice CRUD operations with the MERN stack.',
      type: 'Personal Project',
    ...
    },
    {
      title: 'AI Coder',
      description:
        'A Next JS-based website integrated with Llama 405B to create React components with prompts.',
      type: 'Personal Project',
      imageUrl: '/images/projects/aicoder.png',
      githubUrl: 'https://github.com/jei3m/ai-coder',
      demoUrl: 'https://ai-coder-llama.netlify.app',
      skills: ['Next JS', 'Llama 3.3', 'Tailwind'],
    },
    {
      title: 'Pogi Typings',
      description:
        'A React JS website with Gemini AI to correct punctuation and spelling of Taglish sentences.',
      type: 'Personal Project',
      imageUrl: '/images/projects/pogi.png',
      githubUrl: 'https://github.com/jei3m/pogi-typings',
      demoUrl: 'https://pogi-typings.vercel.app',
      skills: ['React JS', 'Gemini', 'CSS'],
    },
    {
      title: 'Ollama Chat',
      description:
        'A Next JS-based project that serves as an intuitive UI for running local Ollama models.',
      type: 'Personal Project',
    ...
    },
    {
      title: 'About Me',
      description:
        'A requirement for our Software Development course, built with HTML and CSS.',
      type: 'School Project',
      imageUrl: '/images/projects/aboutme.png',
      githubUrl:
        'https://github.com/jei3m/SDEV_Experiment-4/tree/main',
    ...
    },
    {
      title: 'React Pokemon',
      description:
        'A simple turn based Pokemon battle game built with React JS and Tailwind CSS.',
      type: 'School Project',

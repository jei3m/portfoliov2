    ...
    <div className="bg-gray/10 backdrop-blur-sm flex p-4 md:p-6 lg:p-4 xl:p-0">
      <div className="mx-auto flex flex-col items-center justify-center relative">
        <section id="projects" className="w-full">
          ...
          >
            <h2 className="text-2xl md:text-5xl font-semibold text-yellow-50 border-b border-neutral-700 pb-4">
              Featured Projects.
            </h2>
          ...
          <div className="flex items-stretch pt-[1rem]">
            ...
            >
              <div
                className={`grid ${isMobile ? 'grid-cols-1' : 'grid-cols-2'} gap-10 mx-3 lg:mx-0 items-stretch`}
              >
                {DATA.projects
          ...
          <div className="flex justify-center pt-10 md:pt-[4rem] gap-4">
            <TransitionLink href="/projects">
              ...
              >
                <span className="mt-[1px]">View All</span>
                <FiArrowRightCircle className="mt-0.5 ml-1 h-5 w-5 md:h-8 md:w-8" />
              </button>
            </TransitionLink>
          </div>
        </section>

...
<img src="https://github.com/user-attachments/assets/41a04621-ba4c-4440-af4f-1e572a43edca" width="400" className="rounded-xl" alt="ESP32 Development Board" />
...
<img src="https://github.com/user-attachments/assets/23f49f05-ef8f-48cc-85aa-bf335c50f4be" width="400" className="rounded-xl" alt="DHT22 Temperature and Humidity Sensor" />
...
<img src="https://github.com/user-attachments/assets/c9811138-0278-4bb1-bf75-0ca1785fb7f3" width="400" className="rounded-xl" alt="YF-S201 Water Flow Sensor" />
...
<img src="https://github.com/user-attachments/assets/6682ce8d-7d46-4129-adb0-a6f2a5172d39" width="400" className="rounded-xl" alt="PH-4502C pH Sensor Module" />
...
<img src="https://github.com/user-attachments/assets/57ce72b4-f97a-4060-8605-ef03667b44b8" width="400" className="rounded-xl" alt="0.96 OLED Display Screen" />

## Schematic

The schematic diagram below illustrates the connections between the ESP32 Dev Board and the aforementioned sensors:

<img src="https://github.com/user-attachments/assets/c39699b8-886d-4988-b4f2-5487bd710778" className="rounded-xl" alt="Schematic Diagram of AI-Ponics System" />

### DHT22

<img src="https://github.com/user-attachments/assets/84ef0929-5de7-4a24-a241-93d825834378" className="rounded-xl" alt="DHT22 Sensor Connection Diagram" />
...
<img src="https://github.com/user-attachments/assets/6a865d2e-c72d-472c-bb8e-967aaf142d0d" className="rounded-xl" alt="YF-S201 Water Flow Sensor Connection Diagram" />
...
<img src="https://github.com/user-attachments/assets/2fbda1f2-2a9d-48e7-ae38-5d7659c5e01e" className="rounded-xl" alt="OLED Display Connection Diagram" />
...
<img src="https://github.com/user-attachments/assets/1d0d9d82-6f38-48cb-90e7-c3b4780fb559" className="rounded-xl" alt="PH-4502C pH Sensor Connection Diagram" />
